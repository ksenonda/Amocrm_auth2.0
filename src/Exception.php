...
class Exception extends \Exception
{
    ...
    protected $errors = [
        ...
        '301' => 'Домен был изменен',
        '400' => 'Переданы некорректные данные',//Неверная структура массива передаваемых данных, либо не верные идентификаторы кастомных полей
        '401' => 'Пользователь не авторизован, проверьте токен',
